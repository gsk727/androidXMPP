...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-example-atlove.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-example-atlove)

This repository contains the source code for the [atLove](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.example.atLove).

Please see the [issues](https://github.com.example.atLove/com-example-atlove/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about atLove? Ask away on the [com-example-atlove discussion forum](https://groups.google.com/forum/#!forum/com-example-atlove).

<a href="https://play.google.com/store/apps/details?id=com.example.atLove" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.example.atLove__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.example.atLove__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.example.atLove.R__) will now be renamed
...
signed with a different key.  Manually uninstall atLove from your device and
...
atLove is a result of a template project I've developed over the years as well as
...
atLove is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.example.atLove/com-example-atlove/contributors) on
...
[pull requests](https://github.com.example.atLove/com-example-atlove/pulls).
